...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, navigate,
        token, setToken, setCartItems } = useContext(ShopContext)
        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    {/*Dropdown Menu */}
                    {token && <div className='group-hover:block pt-4 absolute right-0 dropdown-menu hidden'>
                        <div className='flex flex-col gap-2 w-36 py-3 px-5 rounded bg-slate-100 
                        text-gray-500'>
                            <p className='cursor-pointer hover:text-black'>My Profile</p>
                            <p className='cursor-pointer hover:text-black'
                                onClick={() => navigate('/order')}>Orders</p>
                            <p className='cursor-pointer hover:text-black'
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] text-center w-4 leading-4 
